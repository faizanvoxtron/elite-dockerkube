...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('tmr_test@voxtrongroup.com', 'Elite Design Studios');
        $mail->addAddress('support@elitedesignstudios.com', 'Elite Design Studios');

        // Content
        $mail->isHTML(true);  // Set email format to HTML
        $mail->Subject = 'New Elite Design Studios Query Submission';
        // $imageUrl = 'https://elitedesignstudios.com/assets/images/logo.svg';
        // $imageData = base64_encode(file_get_contents('assets/images/logo.svg'));
        // <img src='$imageUrl' alt='Elite Design Studios' style='max-width: 200px; height: auto;'>
        $mail->Body = "
        <div style='font-family: Arial, sans-serif; color: #333; line-height: 1.6; background: #f4f4f4; padding: 20px; max-width: 600px; margin: auto;'>
            <div style='background: #120336; color: #fff; padding: 20px; text-align: center;'>
                <h2 style='margin: 0;'>Elite Design Studios</h2>
            </div>
            <div style='background: #ffffff; padding: 20px; border-top: 5px solid #120336;'>
                <p style='margin: 0;'><strong>Name:</strong> $name</p>
                <p style='margin: 0;'><strong>Email:</strong> <a href='mailto:$email' style='color: #dc4242; text-decoration: none;'>$email</a></p>
                <p style='margin: 0;'><strong>Phone:</strong> <a href='tel:$phonenumber' style='color: #dc4242; text-decoration: none;'>$phonenumber</a></p>
            ...
            <div style='background: #120336; color: #fff; text-align: center; padding: 10px; font-size: 12px;'>
                <p style='margin: 0;'>This email was sent from Elite Design Studios.</p>
            </div>
        </div>";
        ...
        if (!$mail->send()) {
            ...
            header('Location: https://elitedesignstudios.com?submitted=1');
