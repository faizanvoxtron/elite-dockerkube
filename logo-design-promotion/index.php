            ...
            <div class="col-lg-6">
                <div class="banner-content">
                    ...
                    <div class="owl-carousel owl-theme" id="logos-carousel">
                        <div class="item">
                            <img src="assets/images/banner-logo-1.webp" alt="Elite Design Studios">
                        </div>
                        <div class="item">
                            <img src="assets/images/banner-logo-2.webp" alt="Elite Design Studios">
                        </div>
                        <div class="item">
                            <img src="assets/images/banner-logo-3.webp" alt="Elite Design Studios">
                        </div>
                        <div class="item">
                            <img src="assets/images/banner-logo-4.webp" alt="Elite Design Studios">
                        </div>
                        <div class="item">
                            <img src="assets/images/banner-logo-5.webp" alt="Elite Design Studios">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="owl-carousel owl-theme" id="logo-types-carousel">
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/3d.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
            ...
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/an-sliderlogo.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
            ...
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/flat.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
            ...
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/icon-based.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
            ...
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/illustrative.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
            ...
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/abstract.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
            ...
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/mascot-logo.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
            ...
            <div class="item">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <img loading="lazy" src="assets/images/logo-types/typo.webp" alt="Elite Design Studios">
                    </div>
                    <div class="col-lg-8">
                        <div class="top-headings">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-12">
                <div class="img-box">
                    <img src="assets/images/pldaward.webp" alt="Elite Design Studios">
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-12">
                <div class="img-box">
                    <img src="assets/images/pldaward2.webp" alt="Elite Design Studios">
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-12">
                <div class="img-box">
                    <img src="assets/images/pldaward3.webp" alt="Elite Design Studios">
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-12">
                <div class="img-box">
                    <img src="assets/images/pldaward4.webp" alt="Elite Design Studios">
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-12">
                <div class="img-box">
                    <img src="assets/images/pldaward5.webp" alt="Elite Design Studios">
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-12">
                <div class="img-box">
                    <img src="assets/images/pldaward6.webp" alt="Elite Design Studios">
                </div>
            </div>
        </div>
    </div>
