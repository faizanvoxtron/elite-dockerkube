...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/favicon.png" type="image/png?v=1">
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <div class="logo-div">
                    <a class="navbar-brand" href="javascript:void(0)"><img src="assets/images/logo.svg" alt="Elite Design Studios" width="200px"></a>
                    <!-- <a class="navbar-brand" href="/"><img src="assets/images/logo-hvr.svg" width="200px" class="logo-img hd-hover-logo" alt="Elite Design Studios"></a> -->
                </div>
