        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col-md-4 col-12">
                <ul>
                    ...
                    <li><i class="ic-5 fa-solid fa-envelope fa-beat"></i><a href="mailto:support@elitedesignstudios.com" target="_blank">support@elitedesignstudios.com</a></li>
                    <li><i class="fa-solid fa-location-dot fa-beat"></i><a href="https://maps.app.goo.gl/TBY69YWL4SrCDweGA" target="_blank">26791 Aliso Creek Rd,Aliso Viejo, CA 92656</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="btn-wrap">
                    <a href="javascript:void(0)" class="btn btn-primary chat chatt live_chat">LET'S CHAT</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sec-copyright">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="content">
                        <p> © Copyright Elite Design Studios. All Rights Reserved 2024</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <img src="assets/images/payments-icons-new.png" alt="Elite Design Studios" width="100%">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12 popup-right-col">
                        ...
                        <form class="popupForm" id="popupForm" method="POST" action="form-bootstrap/lead.php" enctype="multipart/form-data">
                            <input type="hidden" id="popup_form_price" name="price" value="$35.99">
                            <input type="hidden" id="popup_form_title" name="package" value="LOGO SPECIAL PACKAGE">
...
<script src="assets/js/custom-validation.js?v=1.2"></script>
...
<script>
    ...
    $(".popup_form_price_change").click(function() {
        let price = $(this).data('package_price');
        let name = $(this).data('package_name');

        $('#popup_form_price').val(price);
        $('#popup_form_title').val(name);
    })
</script>
