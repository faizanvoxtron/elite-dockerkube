<!-- Header Include -->
<?php
$pageTitle = "Brief Form | Elite Design Studios";
$pageDescription = "";
...
<section class="privacy-terms checkout brief-form">
    <div class="container">
        ...
        <form id="brief-form">
            ...
            <input type="hidden" name="source" value="https://elitedesignstudios.com">
            <!-- Business Name Input -->
            <div class="mb-5">
...
<!-- CRM Service -->
<script>
    var api_base_url = "https://dashboard.elitedesignstudios.com/dynamic_form/api/"
    var form = $('#brief-form')
