...
// $api_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoiQnJhbmQiLCJuYW1lIjoiQnJhbmQiLCJBUElfVElNRSI6MTczMDIyNzQ2NH0.HN2_P4xE2CfOXWl9FUrptEmodDMQV6NtHUtY09yr0XI";
// $api_base_url = 'https://dashboard.elitedesignstudios.com/api/';
$items = [
    [
...
if ($invoice_info->status) {
    $invoice_url = "https://dashboard.elitedesignstudios.com/invoice/" . $invoice_info->invoice->id . "/" . $invoice_info->invoice->hash;
    // echo json_encode([
    //     'status' => true,
    //     'message' => "Success",
    //     'url' => $invoice_url,
    ...
    // CATCH ERRORS
    $payment_page_url = "https://elitedesignstudios.com/checkout.php";
    // echo json_encode([
    //     'status' => false,
...
{
    $url = "https://dashboard.elitedesignstudios.com/api/leads/" . $lead_id;
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_HTTPHEADER, [
        'authtoken:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoiQnJhbmQiLCJuYW1lIjoiQnJhbmQiLCJBUElfVElNRSI6MTczMDIyNzQ2NH0.HN2_P4xE2CfOXWl9FUrptEmodDMQV6NtHUtY09yr0XI',
    ]);
...
{
    $url = "https://dashboard.elitedesignstudios.com/api/customers";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
...
{
    $url = "https://dashboard.elitedesignstudios.com/api/contacts";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
...
{
    $url = "https://dashboard.elitedesignstudios.com/api/invoices";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
