<!-- Header Include -->
<?php
$pageTitle = "2D & 3D illustration Designs and Services in USA";
        ...
        <div class="row align-items-center h-100">
            <div class="col-lg-12">
                <div class="banner-content">
                    <h1 data-aos="fade-down" data-aos-duration="2000">2D & 3D illustration</h1>
                    <p data-aos="fade-up" data-aos-duration="2000">A creative illustration helps you communicate your brand message through appealing visualization.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="portfolio">
    <div class="container">
        <div class="top-headings">
            ...
            <p>We have the best team adopting a highly integrated approach to create your digital assets that represent your brand philosophy in the finest manner. Have a look at some of our finest works of illustrations done for clients.</p>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-8 col-12">
                <div class="left-col">
                    <div class="top-headings">
                        <h2>Logo Packages Tailor-Made for you</h2>
                        <p>Elite Design Studios operates on the philosophy of perfection; we don’t settle until your needs are perfectly served. See our budget friendly packages that you choose to go forward. Or contact us to get to know the best package for you.</p>
...
<section class="packages services-packages">
    <div class="container">
        <div class="top-headings">
            <h2 data-aos="fade-down" data-aos-duration="2000"> Budget-friendly illustration design services with no compromise on quality</h2>
                        ...
                        <div class="owl-carousel owl-theme" id="packages-carousel">
                            <div class="item">
                                <div class="package-box package-1">
                                    <div class="pck-head">
                                        <h4 class="pck-title">
                                            <span>Basic Illustrative Logo Package</span>
                                        </h4>
                                        <span class="pNote">Suitable for potential super-startups and brand revamps for companies.</span>
                                        <div class="pck-price">
                                            <h5><span class="dollar">$</span><strong class="price">294</strong></h5>
                                            <strike>$588<span> <br>Only</span></strike>
                                        </div>
                                    </div>
                                    <div class="pck-content">
                                        <div class="pck-topContent">
                                            <ul class="scrollbar">
                                                <li><i class="ic-tik fa-solid fa-check"></i>3 Custom Logo Design Concepts</li>
                            ...
                            <div class="item">
                                <div class="package-box package-1">
                                    <div class="pck-head">
                                        <h4 class="pck-title">
                                            <span>Startup Illustrative Logo Package</span>
                                        </h4>
                                        <span class="pNote">Suitable for potential super-startups and brand revamps for companies.</span>
                                        <div class="pck-price">
                                            <h5><span class="dollar">$</span><strong class="price">394</strong></h5>
                                            <strike>$788<span> <br>Only</span></strike>
                                        </div>
                                    </div>
                                    <div class="pck-content">
                                        <div class="pck-topContent">
                                            <ul class="scrollbar">
                                                <li><i class="ic-tik fa-solid fa-check"></i>4 Custom Logo Design Concepts</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>By 3 Designers</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>48 to 72 hours TAT</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>UNLIMITED Revisions</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>All Final Files Format (AI, PSD, EPS, PNG, GIF, JPG, PDF)</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>100% Ownership Rights</li>
                            ...
                            <div class="item">
                                <div class="package-box package-1">
                                    <div class="pck-head">
                                        <h4 class="pck-title">
                                            <span>Professional Illustrative Package</span>
                                        </h4>
                                        <span class="pNote">Suitable for potential super-startups and brand revamps for companies.</span>
                                        <div class="pck-price">
                                            <h5><span class="dollar">$</span><strong class="price">594</strong></h5>
                                            <strike>$1188<span> <br>Only</span></strike>
                                        </div>
                                    </div>
                                    <div class="pck-content">
                                        <div class="pck-topContent">
                                            <ul class="scrollbar">
                                                ...
                                                <li><i class="ic-tik fa-solid fa-check"></i>UNLIMITED Revisions</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>24 to 48 hours TAT</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>100% Ownership Rights</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>100% Satisfaction Guarantee</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>100% Unique Design Guarantee</li>
                                                <li><i class="ic-tik fa-solid fa-check"></i>100% Money Back Guarantee *</li>
                            ...
                            <div class="item">
                                <div class="package-box package-1">
                                    <div class="pck-head">
                                        <h4 class="pck-title">
                                            <span>3D Logo Package</span>
                                        </h4>
                                        <span class="pNote">Suitable for potential super-startups and brand revamps for companies.</span>
                                        <div class="pck-price">
                                            <h5><span class="dollar">$</span><strong class="price">544</strong></h5>
                                            <strike>$1088<span> <br>Only</span></strike>
                                        </div>
                                    </div>
                                    <div class="pck-content">
                                        <div class="pck-topContent">
