<!-- Header Include -->
<?php
$pageTitle = "Contact Us | Elite Design Studios";
$pageDescription = "";
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 align-self-center">
                <div class="top-headings-left">
                    ...
                    <h3>Fill out the form to get in touch with Elite Design Studios team</h3>
                    ...
                    <div class="bottom-links">
                        ...
                        <a href="mailto:support@elitedesignstudios.com" class="btn-link"> <i class="ic-3 fa-solid fa-envelope fa-beat"></i>support@elitedesignstudios.com</a>
                        <a href="https://maps.app.goo.gl/TBY69YWL4SrCDweGA" class="btn-link"> <i class="fa-solid fa-location-dot fa-beat"></i>26791 Aliso Creek Rd,Aliso Viejo, CA 92656</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
