<!-- Header Include -->
<?php
$pageTitle = "Affordable Video Animation Services in USA";
        ...
        <div class="row align-items-center h-100">
            <div class="col-lg-12">
                <div class="banner-content">
                    <h1 data-aos="fade-down" data-aos-duration="2000">Motion Graphics</h1>
                    <p data-aos="fade-up" data-aos-duration="2000">Conveying your brand’s message through interactive storytelling with our 2D and 3D video animation services to connect better with your audience.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="portfolio">
    <div class="container">
        <div class="top-headings">
            <h2 data-aos="fade-down" data-aos-duration="2000">Our Outstanding Portfolio</h2>
            <p>Our customers have effectively communicated their brand value through our creatively designed 2D and 3D animated explainer videos. Have a look at them below.</p>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-8 col-12">
                <div class="left-col">
                    <div class="top-headings">
                        <h2>Bring your Powerful Story to Life and Realize its True Potential</h2>
                        <p>You might not be able to tell your story effectively, mainly because of complexity. But a professionally created 2D or 3D animated explainer video will do your job and tell your story more engagingly than ever. With our expert animation team at your disposal, we can help you realize the true potential of your brand which you might not know of yet. See our packages below and learn which one fits you the most.</p>
