<!-- Header Include -->
<?php
$pageTitle = "Creative Copywriting Company in USA";
        ...
        <div class="row align-items-center h-100">
            <div class="col-lg-12">
                <div class="banner-content">
                    <h1 data-aos="fade-down" data-aos-duration="2000">Creative Copywriting</h1>
                    <p data-aos="fade-up" data-aos-duration="2000">Creating powerful content for clients that sells like hotcakes. Our team of creative SEO copywriters helps you in making content that connects with the audience and represents your credo and philosophy inclusively.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="portfolio">
    <div class="container">
        <div class="top-headings">
            <h2 data-aos="fade-down" data-aos-duration="2000">Compelling Copywriting that speaks <br> on your Behalf</h2>
            <p>Copywriting done right can be a crucial tool that sells your business better than anything online. Copywriting acts as the attention grabber for your customers and has the potential to turn your mere viewers into customers. Our creative SEO copywriting services comes with over 10 years of industry experience are highly skilled in creating copies that make your content come to life through short, simple yet effective text that engages the customers in an instance. We are a premium SEO copywriting agency providing SEO friendly content for elevating your brand to next level.</p>
        </div>
    </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-8 col-12">
                <div class="left-col">
                    <div class="top-headings">
                        <h2>Multiple Packages for your Every Need</h2>
                        <p>Our team has laid out the foundation of various packages, depending upon your level of need and helping your brand achieve the success it deserves.</p>
